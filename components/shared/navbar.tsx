          ...
          {isLoggedIn ? (
            ...
            <>
              <Link href="/login">
                <Button
                  variant="default"
                  className="group relative flex items-center gap-2 rounded-4xl bg-primary px-5 py-2.5 font-semibold text-white shadow-md shadow-primary/20 transition-all duration-300 hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/30 active:scale-[0.98] cursor-pointer"
                >
                  <span>Login</span>
