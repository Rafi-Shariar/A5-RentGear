...
const HeroCard = () => {
    ...
    const icons = [
        { Icon: Mountain, className: "hidden md:block top-[15%] left-[10%] text-blue-300 w-10 h-10" },
        { Icon: Camera, className: "hidden md:block top-[40%] left-[8%] text-amber-200 w-8 h-8 rotate-12" },
        { Icon: Bike, className: "hidden md:block top-[70%] left-[15%] text-teal-300 w-12 h-12 -rotate-15" },
        { Icon: Tent, className: "hidden md:block top-[15%] right-[10%] text-green-300 w-10 h-10" },
        { Icon: BookOpenText, className: "hidden md:block top-[45%] left-[20%] text-green-300 w-9 h-9" },
        { Icon: Umbrella, className: "hidden md:block top-[35%] right-[12%] text-red-200 w-8 h-8 -rotate-12" },
        { Icon: Dumbbell, className: "hidden md:block top-[65%] right-[16%] text-purple-300 w-10 h-10 rotate-15" },
        { Icon: GlassWater, className: "hidden md:block top-[75%] right-[26%] text-purple-300 w-10 h-10 rotate-15" },
    ];
    ...
    return (
        <section className="relative w-full max-w-7xl mx-auto min-h-[500px] lg:min-h-[600px] flex items-center justify-center overflow-hidden rounded-3xl mt-26 bg-[#0a1122] shadow-[0_20px_50px_rgba(0,0,0,0.4)]">
            ...
            <div className="relative z-10 max-w-4xl px-8 py-16 text-center text-white flex flex-col items-center">
                ...
                <Button className={''}>Find Your Gear</Button>
