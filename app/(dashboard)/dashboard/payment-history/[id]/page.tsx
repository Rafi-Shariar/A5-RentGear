...
const PaymentDetailsPage = async ({ params }: Props) => {
  ...
  if (!payment) {
    return (
      <div className="min-h-[50vh] flex flex-col items-center justify-center gap-3">
        <p className="text-gray-600 dark:text-zinc-400 font-medium">Payment Record Not Found</p>
        <Link href="/dashboard/payment-history" className="text-sm text-primary underline">
          Back to Payments
        </Link>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-zinc-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transition-colors">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            ...
            <span className="inline-flex items-center gap-1.5 bg-green-50 dark:bg-green-950/40 text-green-700 dark:text-green-400 text-xs font-semibold px-3 py-1 rounded-full border border-green-200 dark:border-green-800/50">
          ...
          <p className="text-sm text-gray-500 dark:text-zinc-400 flex items-center gap-1.5">
            ...
            <span className="font-mono text-gray-700 dark:text-zinc-300 bg-gray-100 dark:bg-zinc-800 px-2 py-0.5 rounded text-xs border dark:border-zinc-700">
        ...
        <div className="text-left sm:text-right bg-gray-50 dark:bg-zinc-800/50 sm:bg-transparent sm:dark:bg-transparent p-4 sm:p-0 rounded-lg w-full sm:w-auto">
          <p className="text-xs text-gray-500 dark:text-zinc-400 uppercase tracking-wider font-semibold">Total Paid Amount</p>
          <p className="text-3xl font-black text-gray-900 dark:text-white">${payment.amount}</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-zinc-800 space-y-4 transition-colors">
            ...
            <div className="flex flex-col sm:flex-row gap-5 items-start">
              <div className="relative w-full sm:w-36 h-36 rounded-lg overflow-hidden bg-gray-100 dark:bg-zinc-800 flex-shrink-0 border border-gray-200 dark:border-zinc-700">
                <img
                  src={gear.imageURL}
                  alt={gear.title}
              ...
              <div className="space-y-2 flex-grow">
                ...
                <h3 className="font-bold text-gray-900 dark:text-zinc-100 text-lg leading-snug">{gear.title}</h3>
                <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-zinc-400 pt-2">
                  <span className="font-semibold text-gray-900 dark:text-white">${gear.price} <span className="text-xs font-normal text-gray-500 dark:text-zinc-400">/ day</span></span>
                  <span>•</span>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-zinc-800 space-y-4 transition-colors">
            <h2 className="text-base font-semibold text-gray-900 dark:text-white flex items-center justify-between border-b border-gray-100 dark:border-zinc-800 pb-3">
              ...
              <span className="text-xs font-semibold bg-gray-100 dark:bg-zinc-800 text-gray-700 dark:text-zinc-300 px-2.5 py-1 rounded-md border dark:border-zinc-700">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-zinc-800 space-y-4 transition-colors">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-6 text-sm">
              <div>
                <p className="text-xs text-gray-500 dark:text-zinc-400">Order Reference ID</p>
                <p className="font-mono text-xs font-semibold text-gray-800 dark:text-zinc-200 break-all">{order.orderId}</p>
              </div>
              <div>
                <p className="text-xs text-gray-500 dark:text-zinc-400">Order Status</p>
                <span className="inline-block mt-0.5 text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase">
                  {order.status}
                </span>
              </div>
              <div>
                <p className="text-xs text-gray-500 dark:text-zinc-400">Order Placed Date</p>
              ...
              <div>
                <p className="text-xs text-gray-500 dark:text-zinc-400">Order Last Updated</p>
                <p className="font-medium text-gray-800 dark:text-zinc-200">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-zinc-800 space-y-5 transition-colors">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between text-gray-600 dark:text-zinc-400">
                ...
                <span className="font-medium text-gray-900 dark:text-zinc-200">${gear.price}</span>
              </div>
              <div className="flex justify-between text-gray-600 dark:text-zinc-400">
                <span>Duration</span>
              ...
              <div className="flex justify-between text-gray-600 dark:text-zinc-400">
                ...
                <span className="font-medium text-gray-900 dark:text-zinc-200">${order.totalAmount}</span>
              </div>

              <div className="flex justify-between text-gray-600 dark:text-zinc-400">
                <span>Payment Method</span>
                <span className="font-semibold text-gray-900 dark:text-zinc-200 capitalize flex items-center gap-1">
                  <CreditCard className="w-3.5 h-3.5 text-gray-500 dark:text-zinc-400" /> {payment.method}
                </span>
              </div>
            ...
            <div className="space-y-3 text-xs">
              <div>
                <p className="text-gray-500 dark:text-zinc-400 flex items-center gap-1">
                  <User className="w-3 h-3 text-gray-400 dark:text-zinc-500" /> Customer Account ID
                </p>
                <p className="font-mono text-gray-800 dark:text-zinc-300 break-all mt-0.5">{payment.customerId}</p>
              </div>

              <div>
                <p className="text-gray-500 dark:text-zinc-400">Payment Completed At</p>
              ...
              <div>
                <p className="text-gray-500 dark:text-zinc-400">Payment Audit Updated</p>
                <p className="font-medium text-gray-800 dark:text-zinc-300 mt-0.5">
